...
var UserTableColumns = struct {
	...
	ID:              "users.id",
	ShopID:          "users.shop_id",
	Name:            "users.name",
	Email:           "users.email",
	EmailVerifiedAt: "users.email_verified_at",
	Password:        "users.password",
	RememberToken:   "users.remember_token",
...
var UserWhere = struct {
	...
	ShopID:          whereHelpernull_Int64{field: "\"users\".\"shop_id\""},
	Name:            whereHelpernull_String{field: "\"users\".\"name\""},
	Email:           whereHelpernull_String{field: "\"users\".\"email\""},
	EmailVerifiedAt: whereHelpernull_String{field: "\"users\".\"email_verified_at\""},
	Password:        whereHelpernull_String{field: "\"users\".\"password\""},
	RememberToken:   whereHelpernull_String{field: "\"users\".\"remember_token\""},
	CreatedAt:       whereHelpernull_String{field: "\"users\".\"created_at\""},
	UpdatedAt:       whereHelpernull_String{field: "\"users\".\"updated_at\""},
	DeletedAt:       whereHelpernull_String{field: "\"users\".\"deleted_at\""},
}
...
func (r *userR) GetUserFavorites() UserFavoriteSlice {
	if r == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "shop_id", "name", "email", "email_verified_at", "password", "remember_token", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "shop_id", "name", "email", "email_verified_at", "password", "remember_token", "created_at", "updated_at", "deleted_at"}
...
func (o *User) Shop(mods ...qm.QueryMod) shopQuery {
...
func (userL) LoadShop(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (userL) LoadUserFavorites(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_favorites.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetShop of the user to the related item.
// Sets o.R.Shop to related.
// Adds o to related.R.Users.
func (o *User) SetShop(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Shop) error {
	var err error
	if insert {
...
func (o *User) RemoveShop(ctx context.Context, exec boil.ContextExecutor, related *Shop) error {
	var err error
...
func (o *User) SetCarts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Cart) error {
	query := "update \"carts\" set \"user_id\" = null where \"user_id\" = ?"
...
func (o *User) SetOrders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Order) error {
	query := "update \"orders\" set \"user_id\" = null where \"user_id\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Reviews accordingly.
// Replaces o.R.Reviews with related.
// Sets related.R.User's Reviews accordingly.
func (o *User) SetReviews(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Review) error {
	query := "update \"reviews\" set \"user_id\" = null where \"user_id\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
// Sets related.R.User.
func (o *User) RemoveReviews(ctx context.Context, exec boil.ContextExecutor, related ...*Review) error {
	if len(related) == 0 {
		return nil
	}
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's UserFavorites accordingly.
// Replaces o.R.UserFavorites with related.
// Sets related.R.User's UserFavorites accordingly.
func (o *User) SetUserFavorites(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserFavorite) error {
	query := "update \"user_favorites\" set \"user_id\" = null where \"user_id\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
// Sets related.R.User.
func (o *User) RemoveUserFavorites(ctx context.Context, exec boil.ContextExecutor, related ...*UserFavorite) error {
	if len(related) == 0 {
		return nil
	}
