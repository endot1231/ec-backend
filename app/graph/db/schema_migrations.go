...
type SchemaMigration struct {
	...
	Dirty   null.String `boil:"dirty" json:"dirty,omitempty" toml:"dirty" yaml:"dirty,omitempty"`
...
var SchemaMigrationWhere = struct {
	...
	Dirty   whereHelpernull_String
}{
	ID:      whereHelpernull_Int64{field: "\"schema_migrations\".\"id\""},
	Version: whereHelpernull_String{field: "\"schema_migrations\".\"version\""},
	Dirty:   whereHelpernull_String{field: "\"schema_migrations\".\"dirty\""},
}
...
var (
	schemaMigrationAllColumns            = []string{"id", "version", "dirty"}
	schemaMigrationColumnsWithoutDefault = []string{}
	schemaMigrationColumnsWithDefault    = []string{"id", "version", "dirty"}
	schemaMigrationPrimaryKeyColumns     = []string{"id"}
	schemaMigrationGeneratedColumns      = []string{"id"}
)
...
func FindSchemaMigration(ctx context.Context, exec boil.ContextExecutor, iD null.Int64, selectCols ...string) (*SchemaMigration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"schema_migrations\" where \"id\"=?", sel,
	)
...
func (o *SchemaMigration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, schemaMigrationGeneratedColumns)
...
func (o *SchemaMigration) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindSchemaMigration(ctx, exec, o.ID)
	if err != nil {
		return err
	}
...
func SchemaMigrationExists(ctx context.Context, exec boil.ContextExecutor, iD null.Int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"schema_migrations\" where \"id\"=? limit 1)"
...
func (o *SchemaMigration) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return SchemaMigrationExists(ctx, exec, o.ID)
}
