...
var OrderWhere = struct {
	...
	ShopID:    whereHelpernull_Int64{field: "\"orders\".\"shop_id\""},
	UserID:    whereHelpernull_Int64{field: "\"orders\".\"user_id\""},
	OrderDate: whereHelpernull_String{field: "\"orders\".\"order_date\""},
	CreatedAt: whereHelpernull_String{field: "\"orders\".\"created_at\""},
	UpdatedAt: whereHelpernull_String{field: "\"orders\".\"updated_at\""},
	DeletedAt: whereHelpernull_String{field: "\"orders\".\"deleted_at\""},
}
...
func (r *orderR) GetOrderDetails() OrderDetailSlice {
	if r == nil {
		return nil
	}
...
func (r *orderR) GetShipments() ShipmentSlice {
	if r == nil {
		return nil
	}
	return r.Shipments
...
var (
	orderAllColumns            = []string{"id", "shop_id", "user_id", "order_date", "created_at", "updated_at", "deleted_at"}
	orderColumnsWithoutDefault = []string{}
	orderColumnsWithDefault    = []string{"id", "shop_id", "user_id", "order_date", "created_at", "updated_at", "deleted_at"}
...
func (o *Order) OrderDetails(mods ...qm.QueryMod) orderDetailQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"order_details\".\"order_id\"=?", o.ID),
	)
...
func (o *Order) Shipments(mods ...qm.QueryMod) shipmentQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"shipments\".\"order_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (orderL) LoadShipments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder interface{}, mods queries.Applicator) error {
	var slice []*Order
	var object *Order
	...
	query := NewQuery(
		qm.From(`shipments`),
		qm.WhereIn(`shipments.order_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Removes o from all passed in related items' relationships struct.
func (o *Order) RemoveShop(ctx context.Context, exec boil.ContextExecutor, related *Shop) error {
	var err error
...
// Sets o.R.Order's OrderDetails accordingly.
// Replaces o.R.OrderDetails with related.
// Sets related.R.Order's OrderDetails accordingly.
func (o *Order) SetOrderDetails(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*OrderDetail) error {
	query := "update \"order_details\" set \"order_id\" = null where \"order_id\" = ?"
...
func (o *Order) RemoveOrderDetails(ctx context.Context, exec boil.ContextExecutor, related ...*OrderDetail) error {
	if len(related) == 0 {
		return nil
	}
...
func (o *Order) SetPayments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Payment) error {
	query := "update \"payments\" set \"order_id\" = null where \"order_id\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
// Sets related.R.Order appropriately.
func (o *Order) AddShipments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Shipment) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.OrderID, o.ID)
...
// order replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Order's Shipments accordingly.
// Replaces o.R.Shipments with related.
// Sets related.R.Order's Shipments accordingly.
func (o *Order) SetShipments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Shipment) error {
	query := "update \"shipments\" set \"order_id\" = null where \"order_id\" = ?"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
// Sets related.R.Order.
func (o *Order) RemoveShipments(ctx context.Context, exec boil.ContextExecutor, related ...*Shipment) error {
	if len(related) == 0 {
		return nil
	}
