...
var AdminTableColumns = struct {
	...
	Name:            "admins.name",
	Email:           "admins.email",
	EmailVerifiedAt: "admins.email_verified_at",
	Password:        "admins.password",
	RememberToken:   "admins.remember_token",
...
var AdminWhere = struct {
	...
	ID:              whereHelpernull_Int64{field: "\"admins\".\"id\""},
	Name:            whereHelpernull_String{field: "\"admins\".\"name\""},
	Email:           whereHelpernull_String{field: "\"admins\".\"email\""},
	EmailVerifiedAt: whereHelpernull_String{field: "\"admins\".\"email_verified_at\""},
	Password:        whereHelpernull_String{field: "\"admins\".\"password\""},
	RememberToken:   whereHelpernull_String{field: "\"admins\".\"remember_token\""},
	CreatedAt:       whereHelpernull_String{field: "\"admins\".\"created_at\""},
	UpdatedAt:       whereHelpernull_String{field: "\"admins\".\"updated_at\""},
	DeletedAt:       whereHelpernull_String{field: "\"admins\".\"deleted_at\""},
}
...
var (
	adminAllColumns            = []string{"id", "name", "email", "email_verified_at", "password", "remember_token", "created_at", "updated_at", "deleted_at"}
	adminColumnsWithoutDefault = []string{}
	adminColumnsWithDefault    = []string{"id", "name", "email", "email_verified_at", "password", "remember_token", "created_at", "updated_at", "deleted_at"}
...
func (q adminQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Admin, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: failed to execute a one query for admins")
	}
...
func (q adminQuery) All(ctx context.Context, exec boil.ContextExecutor) (AdminSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db: failed to assign all query results to Admin slice")
	}
...
func (q adminQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to count admins rows")
	}
...
func (q adminQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db: failed to check if admins exists")
	}
...
func FindAdmin(ctx context.Context, exec boil.ContextExecutor, iD null.Int64, selectCols ...string) (*Admin, error) {
	adminObj := &Admin{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: unable to select from admins")
	}
...
func (o *Admin) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db: no admins provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to insert into admins")
	}
...
func (o *Admin) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db: unable to update admins, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update admins row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by update for admins")
	}
...
func (q adminQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all for admins")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected for admins")
	}
...
func (o AdminSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all in admin slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected all in update all admin")
	}
	return rowsAff, nil
}
...
func (o *Admin) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db: no admins provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("db: unable to upsert admins, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"admins\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert admins")
	}
...
func (o *Admin) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no Admin provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete from admins")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by delete for admins")
	}
...
func (q adminQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db: no adminQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from admins")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by deleteall for admins")
	}
...
func (o AdminSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from admin slice")
	}
...
func (o *AdminSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to reload all in AdminSlice")
	}
...
func AdminExists(ctx context.Context, exec boil.ContextExecutor, iD null.Int64) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db: unable to check if admins exists")
	}
