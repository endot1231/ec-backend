...
const (
	// Label holds the string label denoting the admins type in the database.
	Label = "admins"
	...
	// Table holds the table name of the admins in the database.
	Table = "admins"
)

// Columns holds all SQL columns for admins fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldEmail,
...
// OrderOption defines the ordering options for the Admins queries.
