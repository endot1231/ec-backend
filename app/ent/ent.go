...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			admins.Table:            admins.ValidColumn,
			company.Table:           company.ValidColumn,
			productbrands.Table:     productbrands.ValidColumn,
			productcategories.Table: productcategories.ValidColumn,
			productcolors.Table:     productcolors.ValidColumn,
			productsizes.Table:      productsizes.ValidColumn,
			productstock.Table:      productstock.ValidColumn,
